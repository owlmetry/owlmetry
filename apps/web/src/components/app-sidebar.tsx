...
import { LayoutDashboard, FolderOpen, ScrollText, BarChart3, Filter, KeyRound, Users, UserSearch, ClipboardList, ListChecks, Cog, BookOpen, Plug, Bug, MessageSquare, Star, Megaphone, Globe } from "lucide-react";
