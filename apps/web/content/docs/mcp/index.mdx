...
SDK integration guides (Swift, Node.js, CLI) are distributed as a separate [Claude Code plugin marketplace](https://github.com/owlmetry/owlmetry-skills). Install inside Claude Code with `/plugin marketplace add owlmetry/owlmetry-skills`.
