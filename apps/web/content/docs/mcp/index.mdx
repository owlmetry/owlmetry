...
<Callout>
**Recommended for AI agents.** If your coding agent supports MCP (Claude Code, Cursor, VS Code Copilot, Windsurf, Zed, JetBrains, Cline, Roo Code), use the MCP endpoint instead of the CLI. No installation, no updates, 52 tools available instantly.
</Callout>

Ready to connect? Jump to [Setup](/docs/mcp/setup) for editor-specific configuration.

The endpoint exposes 52 tools covering the same capabilities as the [CLI](/docs/cli): managing projects, apps, metrics, and funnels; querying events and analytics; triaging issues and attachments; running integrations and background jobs; and viewing audit logs.
