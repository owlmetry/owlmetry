...
Apps represent deployable artifacts within a [project](/docs/mcp/projects). Each app has a platform and, for non-backend platforms, a `bundle_id`. Creating an app auto-generates a `client_key` for SDK use.
