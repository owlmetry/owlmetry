...
When an app is created, a client key is automatically generated and stored on the app record for easy retrieval. See [Projects & Apps](/docs/concepts/projects-and-apps) for details.
