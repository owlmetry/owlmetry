...
| `asa_*` | Swift SDK ([auto-captured](/docs/sdks/swift/configuration#apple-search-ads-attribution)) | Apple Search Ads campaign / ad group / keyword / ad / creative set IDs and claim type |
