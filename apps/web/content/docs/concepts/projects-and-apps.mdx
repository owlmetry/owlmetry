...
The key is also stored hashed in the `api_keys` table following the standard [API key security model](/docs/concepts/authentication). The plaintext version on the app record enables easy retrieval for SDK configuration.
