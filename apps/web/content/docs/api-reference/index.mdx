...
| Area | Notes |
|------|-------|
| [Attachments](/docs/api-reference/attachments) | List, fetch, download (signed URL), and delete event attachments; query per-project/user quota usage. Upload endpoints are documented under [Ingest](/docs/api-reference/ingest). |
