...
Yes. The entire codebase — server, web dashboard, CLI, and both SDKs — is available on [GitHub](https://github.com/owlmetry/owlmetry). You can inspect, modify, and self-host it freely.
