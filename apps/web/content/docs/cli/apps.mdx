...
Shows app details including platform, bundle ID, client key, and `latest_app_version` (with the source it was resolved from — App Store or computed). See [Latest Version Detection](/docs/concepts/latest-version-detection).
