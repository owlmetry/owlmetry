...
The `owlmetry ads` subcommand surfaces [Advertising Insights](/docs/concepts/advertising-insights) — campaigns ranked by the lifetime USD revenue of users they brought in. Drill from campaigns into ad groups, then into keywords + ads.
