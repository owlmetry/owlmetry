...
owlmetry audit-log list --team 550e8400-... --since 24h

# API key changes only
owlmetry audit-log list --team 550e8400-... --resource-type api_key

# Deletions in the last week
owlmetry audit-log list --team 550e8400-... --action delete --since 7d

# Actions by a specific user
owlmetry audit-log list --team 550e8400-... --actor a1b2c3d4-...

# Changes to a specific project
owlmetry audit-log list --team 550e8400-... --resource-type project --resource-id 550e8400-...
```
...
```bash
owlmetry audit-log list --team 550e8400-... --format json
```
