...
```bash
owlmetry metrics create --project <id> --name <name> --slug <slug> [options]
```
...
owlmetry metrics query checkout-flow --project 550e8400-... --since 2025-01-08

# Success rate by app version
owlmetry metrics query checkout-flow --project 550e8400-... --group-by app_version

# Duration stats for iOS only
owlmetry metrics query page-load-time --project 550e8400-... --environment ios
```
...
owlmetry metrics events checkout-flow --project 550e8400-... --phase fail

# Trace a specific operation by tracking ID
owlmetry metrics events checkout-flow --project 550e8400-... --tracking-id a1b2c3d4-...
```

## Update a metric

```bash
owlmetry metrics update <slug> --project <id> [options]
```
...
```bash
owlmetry metrics update checkout-flow --project 550e8400-... --status paused
```
