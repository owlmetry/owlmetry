...
Requires Node.js 20+. Pair the CLI with the companion [owlmetry-skills](https://github.com/owlmetry/owlmetry-skills) Claude Code plugin marketplace so your agent has the full command reference and SDK integration patterns.
