...
- **[MCP](/docs/mcp/setup)** (recommended) — Configure a URL once in your editor. No installation, automatic updates, 37 tools available instantly.
- **[CLI](/docs/cli/installation)** — Install the `@owlmetry/cli` npm package. Best for CI/CD, scripts, and human terminal use.

Both paths give your agent the same capabilities. Choose MCP if your editor supports it (Claude Code, Cursor, VS Code, Windsurf, Zed, JetBrains, Cline, Roo Code); choose the CLI for automation pipelines or if you prefer terminal workflows.
