...
owlmetry setup --endpoint https://api.owlmetry.com --api-key owl_agent_your_key_here
```

You can create agent keys from the **API Keys** page in the dashboard. Agent keys have read access to events, metrics, funnels, and other resources.
